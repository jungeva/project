            ...
            <div class="top  ">
                <div class="logo bg-white p10">
                    <div class="flex flex-justify m-t10 m-b5">
                        <div class="title ">
                            <h3 class="font18">
                                <i class="fas fa-file-alt"></i> ${boardTitle} > 게시글 답글작성
                            </h3>
                        </div>
                        
                    </div>
                    <form method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/article/grp_article_reply">
                        ...
                        <table>
                            <tr>
                                ...
                                <td class="td-40 m-lr3 p-lr3">
                                    <select name="division" class="sel-100">
                                    	<option value="1">일반게시물</option>
                                    	<option value="2">알림게시물</option>
                                    </select>
                                </td>
                                <td class="td-10 bg-darkgray center noto black font14" style="background-color:${boardColor}">게시물상태</td>
                            ...
                            <tr>
                                ...
                                <td colspan="3" class="td-90 p-lr3">
                                    <input type="text" name="subject" id="subject" class="input-100" value="[답글] ${list.subject}"/>
                                </td>
                            </tr>
                            <tr>
